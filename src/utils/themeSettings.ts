...
export const TCP_QUALITY_SCORE_MODEL_VERSION = 6
...
export const DEFAULT_THEME_SETTINGS: ThemeSettings = {
  ...
  networkScoreLossWeight: 55,
  networkScoreP50Weight: 20,
  networkScoreP95Weight: 10,
  networkScoreVolatilityWeight: 10,
  networkScoreCoverageWeight: 5,
  networkScoreMinSamples: 30,
  networkScoreMinCoverage: 20,
  networkScoreExcellentThreshold: 90,
  networkScoreGoodThreshold: 80,
  networkScoreFairThreshold: 60,
